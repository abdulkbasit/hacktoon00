...
//             />
//            AB_<span className="text-orange-500">Personal</span>_Gallery
...
//           <div className="w-full px-4 pt-8">{children}
        ...
        <div className="border-b">
          <div className="flex h-20 items-center px-4 container mx-auto">
            <Image
              ...
              className="rounded-full pr-3 "
            />
                 AB_<span className="text-orange-500 font-semibold text-lg">Personal</span>_Gallery
            <div className="ml-auto flex items-center space-x-4">
            <Avatar>
                 <AvatarImage
                   src="/c.webp "
